...
public class UISystemEditor : EditorWindow
{
    ...
    private static readonly string FORM_PATH_TEST = "Assets/Project/Scripts/UI/NGUI/GameSystem/Module/";
    private static readonly string FORM_PATH = "Assets/Project/Scripts/UI/NGUI/GameSystem/";
    ...
    {
        { "u_pnl", typeof(UIPanel) },
        { "u_txt", typeof(UILabel) },
        { "u_btn", typeof(UIButton) },
        { "u_sdr", typeof(UISlider) },
        { "u_spt", typeof(UISprite) },
        { "u_trn", typeof(Transform) },
        { "u_wid", typeof(UIWidget) },
        { "u_box", typeof(BoxCollider) },
        { "u_obj", typeof(GameObject) },
        { "u_slv", typeof(UIScrollView) },
    };

    [MenuItem("Tools/UI/创建\\更新系统", false, 3)]
