...
public abstract class UIBasicSprite : UIWidget
{
    ...
    protected void Fill(List<Vector3> verts, List<Vector2> uvs, List<Color> cols, Rect outer, Rect inner)
    {
        ...
        switch (type)
        {
            ...
            case Type.MirroredRight:
                MirroredRightFill(verts, uvs, cols);
                break;
        }
    }

    /// <summary>
    /// ÎÆÀíÓÒ²à¾µÏñ(·ÇNGUIÔ­Éú)
    /// </summary>

    void MirroredRightFill(List<Vector3> verts, List<Vector2> uvs, List<Color> cols)
    {
        ...
        uvs.Add(new Vector2(u.z - 0.001f, u.w));
        uvs.Add(new Vector2(u.z - 0.001f, u.y));
