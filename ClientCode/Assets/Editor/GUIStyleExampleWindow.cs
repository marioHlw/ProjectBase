/******************************************************
 * 文件名:GUIStyleExampleWindow.cs
 * 文件描述:Unity内置GUIStyle样例预览
 * 创建日期:2019/11/17
 * 作者:ZB
 ******************************************************/
...
public class GUIStyleExampleWindow : EditorWindow
{
    ...
    private static void Example()
    {
        ...
        {
            if (mTypes.IndexOf(mList[i]) == -1)
            {
                mTypes.Add(mList[i].Substring(0, 1));
            }
        }
    }
    ...
    private void OnGUI()
    {
        mTypeIndex = EditorGUILayout.Popup(mTypeIndex, mTypes.ToArray(), GUILayout.Height(30));

        mScrollPos = EditorGUILayout.BeginScrollView(mScrollPos);
        foreach (var n in mList)
        {
            if (!n.StartsWith(mTypes[mTypeIndex])) continue;

            EditorGUILayout.BeginHorizontal();//GUILayout.Height(48)
            EditorGUILayout.SelectableLabel(n, GUILayout.Width(400));
            EditorGUILayout.Toggle(false, n);
            EditorGUILayout.EndHorizontal();
            //GUILayout.Box(string.Empty, GUILayout.Width(position.width - 24), GUILayout.Height(1));
        }
